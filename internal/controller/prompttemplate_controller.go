...
// +kubebuilder:rbac:groups=core.cognet.io,resources=prompttemplates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=core.cognet.io,resources=prompttemplates/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=core.cognet.io,resources=prompttemplates/finalizers,verbs=update
