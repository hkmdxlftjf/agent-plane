...
// +kubebuilder:webhook:path=/validate-core-cognet-io-v1alpha1-agent,mutating=false,failurePolicy=fail,sideEffects=None,groups=core.cognet.io,resources=agents,verbs=create;update,versions=v1alpha1,name=vagent-v1alpha1.kb.io,admissionReviewVersions=v1
